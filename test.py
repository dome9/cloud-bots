...
event = {
    'Records': [{
        ...
        'Sns': {
            ...
            'Message': '{"policy":{"name":"sns_failed_events","description":""},"bundle":{"name":"Copy of sns_send_event_failures","description":""},"reportTime":"2018-01-30T03:05:14.489Z","rule":{"name":"iamuser should fail","description":"","remediation":"","complianceTags":"AUTO: iam_quarantine_user","severity":"High"},"status":"Failed","account":{"id":"621958466464","vendor":"Aws"},"entity":{"createDate":1483998628,"passwordLastUsed":1517239732,"arn":"arn:aws:iam::621958466464:testuser2","path":null,"managedPolicies":null,"inlinePolicies":null,"attachedGroups":null,"passwordEnabled":false,"passwordLastChanged":-62135596800,"passwordNextRotation":-62135596800,"mfaActive":false,"firstAccessKey":{"isActive":true,"lastRotated":1505498566,"lastUsedDate":-62135596800,"lastUsedRegion":"","lastUsedService":""},"secondAccessKey":{"isActive":true,"lastRotated":1505498570,"lastUsedDate":-62135596800,"lastUsedRegion":"","lastUsedService":""},"firstCertificate":{"isActive":false,"lastRotated":-62135596800},"secondCertificate":{"isActive":false,"lastRotated":-62135596800},"combinedPolicies":null,"vpc":null,"id":"","type":"IamUser","name":"testuser2","dome9Id":"","accountNumber":"621958466464","region":null,"source":"db","tags":[]}}',
...
#IAM ROLE EXAMPLE:
{
    ...
    "entity": {
        "arn": "arn:aws:iam::621958466464:role/readonlypermissionsdome9-Role-HZQA3GMOJELS",
        "assumeRolePolicy": {
            "Version": "2012-10-17",
            "Statement": [{
                "Effect": "Allow",
        ...
        "combinedPolicies": [{
            ...
            "id": "arn:aws:iam::621958466464:role/readonlypermissionsdome9-Role-HZQA3GMOJELS",
...
#IAM USER EXMAPLE:
{
    ...
    "entity": {
        ...
        "arn": "arn:aws:iam::621958466464:root",
        "path": null,
    ...
    "entity": {
        ...
        "policy": {
            ...
            "Statement": [{
                ...
                "Resource": "arn:aws:s3:::alexalextestbucket"
            }, {
                ...
                "Action": "s3:PutObject",
                "Resource": "arn:aws:s3:::alexalextestbucket/AWSLogs/621958466464/*",
                "Condition": {
                    "StringEquals": {
        ...
        "vpc": null,
        "id": "alexalextestbucket",
        "type": "S3Bucket",
        "name": "alexalextestbucket",
        "dome9Id": "1|89ff48fc-9c8b-4292-a169-d6e938af2dd2|rg|s3Bucket|alexalextestbucket-62362",
        "accountNumber": "621958466464",
        "region": "",
        "source": "db",
        "tags": []
