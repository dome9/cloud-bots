...
You can deploy this stack via the link below. (Currently this only deploys in us-west-2)
...
| Region        | Launch        | 
| ------------- |:-------------:| 
|us-east-1|[<img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png">](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=dome9CloudBots&templateURL=https://s3-us-east-1.amazonaws.com/dome9cftemplatesuseast1/cloudbots_cftemplate.yaml)|
...
|ap-northeast-3|[<img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png">](https://console.aws.amazon.com/cloudformation/home?region=ap-northeast-3#/stacks/new?stackName=dome9CloudBots&templateURL=https://s3-ap-northeast-3.amazonaws.com/dome9cftemplatesapnortheast3/cloudbots_cftemplate.yaml)|
