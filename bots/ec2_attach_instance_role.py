...
Description: Attaches an instance role to an EC2 instance. This role needs be passed in through the params.
Required Permissions: ec2:AssociateIamInstanceProfile
