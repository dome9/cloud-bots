...
def run_action(boto_session, rule, entity, params):
    ...
    for index, param in enumerate(params):
        ...
        else:  # You can configure params without the PARAM_NAME=PARAM_VALUE convention, the same way Dome9 sends remediation action
            if param == '\'\'':
                continue
            if index == TRAIL_NAME_INDEX:
                env_variables['trail_name'] = param
            elif index == BUCKET_NAME_INDEX:
                env_variables['bucket_name'] = param
