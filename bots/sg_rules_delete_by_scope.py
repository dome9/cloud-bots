...
Usage: AUTO: sg_rules_delete_by_scope scope=<a.b.c.d/e> direction=<inbound|outbound> port=<number|*> protocol=<TCP|UDP|*>

Example: AUTO: sg_rules_delete_by_scope scope=0.0.0.0/0 direction=inbound port=22 protocol=TCP
