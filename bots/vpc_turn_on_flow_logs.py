...
def create_log_delivery_policy(boto_session):
    ...
    print("Dome9 Cloud bots - vpc_turn_on_flow_logs.py - Creating log delivery policy")
    try:
        # Create a policy
        delivery_policy = {
            "Version": "2012-10-17",
...
def check_for_log_delivery_policy(boto_session,policy_arn):
    # Create IAM client
    iam_client = boto_session.client('iam')
    print("Dome9 Cloud bots - vpc_turn_on_flow_logs.py - Checking for log delivery policy")
    try:
...
def create_role(boto_session,policy_arn):
    iam_client = boto_session.client('iam')
    print("Dome9 Cloud bots - vpc_turn_on_flow_logs.py - Creating role")
...
def add_policy_to_role(boto_session,policy_arn):        
    # Create IAM client
    iam_client = boto_session.client('iam')
    print("Dome9 Cloud bots - vpc_turn_on_flow_logs.py - adding policy to new role")
...
def create_logs(boto_session,role_id,vpc_id,traffic_type,destination,bucket_arn):
    ...
    print("Dome9 Cloud bots - vpc_turn_on_flow_logs.py - creating vpc flow loggging")
